      ...
      <AnimatePresence>
        {active && typeof active === "object" && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 bg-black/20 h-full w-full z-10 dark:bg-black/40"
          />
        )}
      </AnimatePresence>
      <AnimatePresence>
        {active && typeof active === "object" ? (
          <div className="fixed inset-0 grid place-items-center z-[100]">
            <motion.button
              ...
              className="flex absolute top-2 right-2 lg:hidden items-center justify-center bg-black dark:bg-neutral-800 rounded-full h-6 w-6"
              ...
              <div>
                <div className="flex justify-between items-start p-4">
                  <div className="">
                    <motion.h3
                      ...
                      className="font-bold text-neutral-200 dark:text-neutral-300"
                    >
                      {active.title}
                    </motion.h3>
                    <motion.p
                      layoutId={`description-${active.text}-${id}`}
                ...
                <div className="pt-4 relative px-4">
                  <motion.div
                    ...
                    animate={{ opacity: 1 }}
                    exit={{ opacity: 0 }}
                    className="text-neutral-400 text-xs md:text-sm lg:text-base h-40 md:h-fit pb-10 flex flex-col items-start gap-4 overflow-auto dark:text-neutral-500  [scrollbar-width:none] [-ms-overflow-style:none] [-webkit-overflow-scrolling:touch]"
                  >
            ...
            <div className="flex gap-4 flex-col md:flex-row ">
              <div className="">
                <motion.h3
                  ...
                  className="font-medium text-neutral-400 dark:text-neutral-300 text-center md:text-left "
                >
                  {card.title}
                </motion.h3>
                <motion.p
                  layoutId={`description-${card.text}-${id}`}
                  className="text-neutral-400 dark:text-neutral-500 text-center md:text-left"
                >
                  {card.text}
                </motion.p>
              </div>
...
//           With a career spanning over two decades, Metallica has released
//           numerous hit albums and singles that have garnered them a massive fan
//           following both in the U.S. and abroad.
//         </p>
//       );
//     },
//   },
